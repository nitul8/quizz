      ...
      <div className="flex flex-col items-center bg-[#d1d0ce] p-12 border rounded-2xl shadow-md w-full max-w-[600px]">
        ...
        <form className="w-full space-y-5" onSubmit={handleEmailSignUp}>
          ...
          <div className="flex flex-col w-full">
            <label className="font-semibold text-gray-700 text-lg mb-1" htmlFor="name">Username</label>
            <input
              type="text"
              id="name"
              value={name}
          ...
          {/* Email Field */}
          <div className="flex flex-col w-full">
            <label className="font-semibold text-gray-700 text-lg mb-1" htmlFor="email">Email</label>
            <input
              type="email"
              id="email"
              value={email}
          ...
          {/* Password Field */}
          <div className="flex flex-col w-full">
            <label className="font-semibold text-gray-700 text-lg mb-1" htmlFor="password">Password</label>
            <input
